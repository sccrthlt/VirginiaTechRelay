...
urlpatterns += patterns('relayapp.views',
	...
	url(r'^myCandles/change/$', 'myCandlesChange'),
	url(r'^myCandles/retrieveUsername/$', 'retrieveUsername'),
	url(r'^logout/$', 'userLogout'),
	url(r'^pledgeReceive/$', 'pledgeReceive'),
...
urlpatterns += patterns('relayapp.renderer',
	...
	url(r'^pledge/$', 'renderPledge'),
	url(r'^myCandles/?user=(?P<User>\w+)/$', 'renderMyCandlesPage'),
	url(r'^myCandles/change/?user=(?P<User>\w+)/$', 'renderPassChange'),
	url(r'^myCandles/sendemail/$', 'renderSendEmail'),
	url(r'^counter/$', 'renderCounter'),
	#url(r'^counter/?team=(?P<team>\w+)/$', 'renderCounterTeam'),
