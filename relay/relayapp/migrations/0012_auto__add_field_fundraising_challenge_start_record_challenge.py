...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Fundraising_Challenge_Start_Record.challenge'
        db.add_column('relayapp_fundraising_challenge_start_record', 'challenge',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['relayapp.Fundraising_Challenge']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Fundraising_Challenge_Start_Record.challenge'
        db.delete_column('relayapp_fundraising_challenge_start_record', 'challenge_id')
