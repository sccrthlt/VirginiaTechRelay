...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Fundraising_Challenge_Start_Record'
        db.create_table('relayapp_fundraising_challenge_start_record', (
        ...
        db.send_create_signal('relayapp', ['Fundraising_Challenge_Start_Record'])


    def backwards(self, orm):
        # Deleting model 'Fundraising_Challenge_Start_Record'
        db.delete_table('relayapp_fundraising_challenge_start_record')
