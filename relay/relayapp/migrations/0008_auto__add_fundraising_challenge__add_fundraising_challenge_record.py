...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Fundraising_Challenge'
        db.create_table('relayapp_fundraising_challenge', (
            ...
            ('amount_raised', self.gf('django.db.models.fields.DecimalField')(default='0.00', max_digits=10, decimal_places=2, blank=True)),
            ('candles_raised', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('candles_rewarded', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ...
        db.send_create_signal('relayapp', ['Fundraising_Challenge'])

        # Adding model 'Fundraising_Challenge_Record'
        db.create_table('relayapp_fundraising_challenge_record', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('participant', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['relayapp.Participant'])),
            ('challenge', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['relayapp.Fundraising_Challenge'])),
            ('datetime', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('relayapp', ['Fundraising_Challenge_Record'])


    def backwards(self, orm):
        # Deleting model 'Fundraising_Challenge'
        db.delete_table('relayapp_fundraising_challenge')

        # Deleting model 'Fundraising_Challenge_Record'
        db.delete_table('relayapp_fundraising_challenge_record')
