...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Pledge'
        db.create_table('relayapp_pledge', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sponsor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('pledge_amount', self.gf('django.db.models.fields.DecimalField')(default='0.00', max_digits=10, decimal_places=2, blank=True)),
            ('max_pledge_amount', self.gf('django.db.models.fields.DecimalField')(default='0.00', max_digits=10, decimal_places=2, blank=True)),
            ('datetime', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True)),
        ))
        db.send_create_signal('relayapp', ['Pledge'])


    def backwards(self, orm):
        # Deleting model 'Pledge'
        db.delete_table('relayapp_pledge')
