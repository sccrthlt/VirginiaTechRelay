...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Fundraising_Challenge_Tracker_Record.diffRaised'
        db.delete_column('relayapp_fundraising_challenge_tracker_record', 'diffRaised')

        # Adding field 'Fundraising_Challenge_Tracker_Record.difference_raised'
        db.add_column('relayapp_fundraising_challenge_tracker_record', 'difference_raised',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Fundraising_Challenge_Tracker_Record.difference_candles'
        db.add_column('relayapp_fundraising_challenge_tracker_record', 'difference_candles',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Fundraising_Challenge_Tracker_Record.diffRaised'
        db.add_column('relayapp_fundraising_challenge_tracker_record', 'diffRaised',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Fundraising_Challenge_Tracker_Record.difference_raised'
        db.delete_column('relayapp_fundraising_challenge_tracker_record', 'difference_raised')

        # Deleting field 'Fundraising_Challenge_Tracker_Record.difference_candles'
        db.delete_column('relayapp_fundraising_challenge_tracker_record', 'difference_candles')
