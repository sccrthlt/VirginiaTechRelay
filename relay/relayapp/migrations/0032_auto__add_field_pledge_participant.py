...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Pledge.participant'
        db.add_column('relayapp_pledge', 'participant',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['relayapp.Participant'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Pledge.participant'
        db.delete_column('relayapp_pledge', 'participant_id')
