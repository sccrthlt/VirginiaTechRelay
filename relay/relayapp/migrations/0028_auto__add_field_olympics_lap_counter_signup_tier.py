...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Olympics_Lap_Counter_Signup.tier'
        db.add_column('relayapp_olympics_lap_counter_signup', 'tier',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Olympics_Lap_Counter_Signup.tier'
        db.delete_column('relayapp_olympics_lap_counter_signup', 'tier')
