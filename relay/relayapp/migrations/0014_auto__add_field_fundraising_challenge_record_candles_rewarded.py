...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Fundraising_Challenge_Record.candles_rewarded'
        db.add_column('relayapp_fundraising_challenge_record', 'candles_rewarded',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Fundraising_Challenge_Record.candles_rewarded'
        db.delete_column('relayapp_fundraising_challenge_record', 'candles_rewarded')
