...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Participant.hokie_passport_id'
        db.add_column('relayapp_participant', 'hokie_passport_id',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Participant.hokie_passport_id'
        db.delete_column('relayapp_participant', 'hokie_passport_id')
