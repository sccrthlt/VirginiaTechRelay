...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Team_Captain'
        db.create_table('relayapp_team_captain', (
        ...
        db.send_create_signal('relayapp', ['Team_Captain'])


    def backwards(self, orm):
        # Deleting model 'Team_Captain'
        db.delete_table('relayapp_team_captain')
