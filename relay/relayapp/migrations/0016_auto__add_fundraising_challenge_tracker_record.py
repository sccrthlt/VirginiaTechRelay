...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Fundraising_Challenge_Tracker_Record'
        db.create_table('relayapp_fundraising_challenge_tracker_record', (
            ...
            ('diffRaised', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('datetime', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('relayapp', ['Fundraising_Challenge_Tracker_Record'])


    def backwards(self, orm):
        # Deleting model 'Fundraising_Challenge_Tracker_Record'
        db.delete_table('relayapp_fundraising_challenge_tracker_record')
    ...
    models = {
        ...
        'relayapp.fundraising_challenge_tracker_record': {
            ...
            'challenge': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['relayapp.Fundraising_Challenge']"}),
            'datetime': ('django.db.models.fields.DateTimeField', [], {}),
            'diffRaised': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'participant': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['relayapp.Participant']"})
        },
