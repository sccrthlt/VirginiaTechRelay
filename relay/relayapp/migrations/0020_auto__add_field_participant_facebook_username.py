...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Participant.facebook_username'
        db.add_column('relayapp_participant', 'facebook_username',
                      self.gf('django.db.models.fields.CharField')(default='none', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Participant.facebook_username'
        db.delete_column('relayapp_participant', 'facebook_username')
