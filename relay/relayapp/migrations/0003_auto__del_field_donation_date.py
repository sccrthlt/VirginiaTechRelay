...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('relayapp_donation', 'date')


    def backwards(self, orm):
        # Adding field 'Donation.date'
        db.add_column('relayapp_donation', 'date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 2, 27, 0, 0)),
                      keep_default=False)
