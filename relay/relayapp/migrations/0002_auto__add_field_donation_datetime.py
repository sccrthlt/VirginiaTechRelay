...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Donation.datetime'
        db.add_column('relayapp_donation', 'datetime',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 2, 27, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Donation.datetime'
        db.delete_column('relayapp_donation', 'datetime')
